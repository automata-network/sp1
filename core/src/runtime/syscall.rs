...
use crate::syscall::precompiles::fp384::Fp384MulChip;
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_01_01_20 => SyscallCode::FP384_MUL,
...
pub fn default_syscall_map() -> HashMap<SyscallCode, Arc<dyn Syscall>> {
    ...
    syscall_map.insert(SyscallCode::FP384_MUL, Arc::new(Fp384MulChip::new()));
    ...
    fn test_syscall_consistency_zkvm() {
        for code in SyscallCode::iter() {
            match code {
                ...
                SyscallCode::FP384_MUL => assert_eq!(code as u32, sp1_zkvm::syscalls::FP384_MUL),
                SyscallCode::SECP256K1_DECOMPRESS => {
